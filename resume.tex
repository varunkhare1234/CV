...
\item \textbf{Visiting Research Scholar} (National University Singapore)\\
 \emph{(Guide: Prof. Tat Seng Chua, May'18 - July'18)} \\[-0.6cm]
	...
	\item Proposed an end-to-end architecture to \textbf{reconstruct 3D model} and extract the \textbf{corresponding pose} from canonical viewpoint
	\item Our Neural Net module predicts poses\textbf{ (6 DoF) }in the continuous domain without needing \textbf{PnP} based solvers and hence can be plugged into any architecture 
	\item Results \textbf{better than SOTA} methods using PnP
...
\item \textbf{Software Lead} (New York Office, IIT Kanpur)\\
 \emph{(Guide: Prof. Manindra Agarwal, May'16 - May'18)} \\[-0.6cm]
	...
	\item Lead a team of 12 people at NYO.
	\end{itemize}
\end{itemize}
